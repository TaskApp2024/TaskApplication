...
const CompanyResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log(token);
      const response = await axios.post(`http://16.171.229.175:3001/api/company-reset-password?token=${token}`, { password });
      ...
      setTimeout(() => {
        navigate('/companyLogin'); // Adjust this route to your login page
      }, 2000);
