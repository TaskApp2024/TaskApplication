...
const CompanyProfile = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://localhost:3001/api/company/${companyId}`)
      .then(response => {
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="d-flex justify-content-center mb-4">
            <img src={logoPath ? `https://localhost:3001/${logoPath}` : 'default-placeholder.png'} alt="Company Logo" style={{ width: '100px' }} />
          </div>
